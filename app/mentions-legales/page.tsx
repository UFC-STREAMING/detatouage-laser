      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">1. Éditeur du site</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">2. Directeur de la publication</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">3. Hébergement</h2>
            <p className="text-[var(--text-secondary)]">
              <strong>Hébergeur :</strong> Vercel Inc.<br />
              <strong>Adresse :</strong> 340 S Lemon Ave #4133, Walnut, CA 91789, USA<br />
              <strong>Site web :</strong> <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-[var(--color-primary)] hover:underline">vercel.com</a>
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">4. Propriété intellectuelle</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">5. Responsabilité</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">6. Liens hypertextes</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">7. Droit applicable</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">8. Contact</h2>
            <p className="text-[var(--text-secondary)]">
              Pour toute question concernant les mentions légales, vous pouvez nous contacter à l'adresse suivante :<br />
              <strong>Email :</strong> <a href="mailto:contact@tatouage-temporaire.fr" className="text-[var(--color-primary)] hover:underline">contact@tatouage-temporaire.fr</a>
            </p>
          </section>
