    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">2. Responsable du traitement</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">8. Vos droits</h2>
            <p className="text-[var(--text-secondary)] mb-4">
            ...
            <p className="text-[var(--text-secondary)] mt-4">
              ...
              <a href="mailto:contact@tatouage-temporaire.fr" className="text-[var(--color-primary)] hover:underline ml-1">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">9. Cookies</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">10. Sécurité</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--color-primary)] mb-4">12. Contact</h2>
            <p className="text-[var(--text-secondary)]">
          ...
          <section className="mb-8">
            ...
            <p className="text-[var(--text-secondary)] mt-4">
              ...
              Site web : <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-[var(--color-primary)] hover:underline">www.cnil.fr</a>
            </p>
          </section>
